...
const BASE_CONTEXTUAL_RULES = Object.freeze([
  ...
  Object.freeze({
    categories: ['usuarios'],
    entities: ['usuario'],
    events: ['actualizar', 'cambiar_password', 'restablecer_password'],
  ...
  Object.freeze({
    categories: ['usuarios'],
    entities: ['usuario'],
    events: ['actualizar', 'asignar_permisos', 'retirar_permisos'],
    fields: ['permisos'],
  ...
  Object.freeze({
    categories: ['seguridad', 'sesiones'],
    entities: ['sesion', 'usuario'],
    events: ['autenticar', 'login', 'logout', 'revocar', 'expirar', 'actualizar'],
  ...
  Object.freeze({
    ...
    entities: ['sesion', 'usuario'],
    events: ['autenticar', 'login', 'logout', 'revocar', 'expirar', 'actualizar'],
    fields: ['sesion_revocada', 'sesion_expirada', 'usuario_inactivo'],
    valueType: AUDIT_VALUE_TYPES.BOOLEAN,
  }),
  Object.freeze({
    categories: ['documentos'],
    entities: ['documento', 'exportacion'],
    events: ['crear', 'generar', 'exportar', 'descargar'],
    fields: ['tipo_documento', 'formato'],
    valueType: AUDIT_VALUE_TYPES.CONTROLLED_CODE,
  }),
  Object.freeze({
    categories: ['reportes'],
    entities: ['reporte', 'exportacion'],
    events: ['generar', 'exportar', 'descargar', 'consultar'],
    fields: ['tipo_reporte', 'formato'],
    valueType: AUDIT_VALUE_TYPES.CONTROLLED_CODE,
  }),
  Object.freeze({
    categories: ['documentos', 'reportes'],
    entities: ['documento', 'reporte', 'exportacion'],
    events: ['crear', 'generar', 'exportar', 'descargar', 'consultar'],
