...
const BASE_CONTEXTUAL_RULES = Object.freeze([
  Object.freeze({
    ...
    events: [
      'crear', 'actualizar', 'eliminar', 'cambiar_estado',
      'reprogramar', 'cancelar', 'atender', 'materializar_inasistencia',
      'materializar_asistencia', 'reconciliar_asistencia_tardia',
      'crear_seguimiento_inasistencia',
    ],
  ...
  Object.freeze({
    categories: ['clinica'],
    entities: ['cita_prenatal'],
    events: ['reprogramar', 'cancelar', 'atender', 'materializar_inasistencia',
      'materializar_asistencia', 'reconciliar_asistencia_tardia',
      'crear_seguimiento_inasistencia'],
    fields: ['estado_cita'],
    valueType: AUDIT_VALUE_TYPES.ENUM,
    allowedValues: ['programada', 'atendida', 'cancelada', 'reprogramada', 'inasistente'],
  }),
  Object.freeze({
    categories: ['clinica'],
    entities: ['cita_prenatal'],
  ...
  Object.freeze({
    ...
    events: ['reprogramar', 'cancelar', 'atender', 'materializar_inasistencia',
      'materializar_asistencia', 'reconciliar_asistencia_tardia',
      'crear_seguimiento_inasistencia'],
    fields: ['cita_nueva_id', 'control_cumplimiento_id'],
    valueType: AUDIT_VALUE_TYPES.NON_NEGATIVE_INTEGER,
  }),
  Object.freeze({
    categories: ['administracion'],
    entities: ['comunidad'],
    events: ['crear', 'actualizar', 'cambiar_estado'],
    fields: ['resultado', 'motivo_codigo'],
    valueType: AUDIT_VALUE_TYPES.CONTROLLED_CODE,
  }),
  Object.freeze({
  ...
  Object.freeze({
    categories: ['automatizaciones'],
    entities: ['inasistencias_semanales'],
  ...
  Object.freeze({
    categories: ['automatizaciones'],
    entities: ['calidad_datos_semanal'],
    events: ['consultar', 'preparar', 'confirmar', 'resolver'],
    fields: ['tipo_automatizacion', 'resultado', 'motivo_codigo'],
    valueType: AUDIT_VALUE_TYPES.CONTROLLED_CODE,
  }),
