      ...
      {loading ? (
        ...
        <>
          ...
          <div style={{
            ...
            <StatCard label="Total de pacientes"   value={stats?.total_pacientes}      variant="primary" Icon={Users}         />
            <StatCard label="Controles este mes"   value={stats?.controles_este_mes}   variant="accent"  Icon={ClipboardList} />
            <StatCard label="Pacientes con riesgo" value={stats?.pacientes_con_riesgo} variant="danger"  Icon={AlertTriangle} />
          </div>
                  ...
                  <tbody>
                    {stats.proximas_citas.map((c, i) => (
                      <tr key={i} style={{ cursor: "pointer" }}
                        ...
                        <td>
                          <span className="badge badge-blue">{c.no_expediente}</span>
                        </td>
                        <td>
                          <span className="badge badge-blue">Control {c.numero_control}</span>
                        </td>
                        <td>
